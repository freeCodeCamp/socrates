...
This document contains 10 diverse example requests for testing the `/hint` endpoint. Each example demonstrates different challenge types and scenarios.

Copy and paste these curl commands directly into your terminal to test the API.
